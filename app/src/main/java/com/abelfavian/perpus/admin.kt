...
class admin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnhapus.setOnClickListener {
            val intent = Intent(this, admin_hapus::class.java)
    ...
    private fun addBookToFirebase(title: String, author: String, imageUrl: String, pdfUrl: String) {
        ...
        val database = FirebaseDatabase.getInstance("https://pilketos24-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("books")
